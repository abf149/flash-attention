"""
Triton-language FlashAttention implementation integrated with One Write Head is All You Need implementation.

Based on OpenAI Triton implementation, from which the comments and most of the implementation below are derived.
------
...
def _fwd_kernel(
    ...
    """
    Combined FlashAttention/One-write-head implementation
...
def _flash_attn_forward(q, k, v, bias=None, causal=False, softmax_scale=None):
    ...
    assert k.shape == (batch, seqlen_k, d)
    assert v.shape == (batch, seqlen_k, d)
    ...
    '''
    stride_qb, stride_qh, stride_qm,
    stride_kb, stride_kh=0, stride_kn,
    stride_vb, stride_vh=0, stride_vn,
    stride_bb, stride_bh, stride_bm,
    stride_ob, stride_oh, stride_om,
    '''
    _fwd_kernel[grid](
...
flash_attn_func_onewritehead = FlashAttnFunc.apply
